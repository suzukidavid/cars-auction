...
import { makePaginatable } from "../helpers/middlewares";
...
const list = async (req, res) => {
  ...
  console.log(" ctr page", page);
  console.log("ctr limit", limit);
  // console.log("Usser check", await makePaginatable(User, page, limit));
  try {
    ...
    return res.status(400).json({
      error: errorHandler.getErrorMessage(`jj${err}`),
    });
  }
};
